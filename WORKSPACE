...
http_archive(
	name = "com_github_bazelboost_typeof",
	strip_prefix = "typeof-boost-1.65.1",
	urls = [
		"https://github.com/bazelboost/typeof/archive/boost-1.65.1.tar.gz"
	],
)
...
http_archive(
	name = "com_github_bazelboost_scope_exit",
	strip_prefix = "scope_exit-boost-1.65.1",
	urls = [
		"https://github.com/bazelboost/scope_exit/archive/boost-1.65.1.tar.gz"
	],
)
